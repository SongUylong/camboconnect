...
// Ensure this points to the correct WhyWeExist component file
import WhyWeExist from "@/components/ui/Why-we-exit";// Corrected import path potentially
...
// Testimonials data (remain the same)
const testimonials = [
    {
...
// Pain points data is likely used within WhyWeExist component, no need here
// const painPoints = [ ... ];
...
export default function Home() {
    return (
        <MainLayout>
                 ...
                 <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 mb-24">
                   <div className="mx-auto max-w-7xl flex flex-col lg:flex-row items-center justify-between relative">
                     ...
                     <div className="mx-auto max-w-2xl text-center lg:w-1/2 z-30 relative">
                       <span className="inline-block px-4 py-1 rounded-full text-sm font-medium bg-white/20 text-white mb-5" data-aos="fade-down" data-aos-delay="100">
                       ...
                       >
                         ...
                         <Link href="/guide" className="text-sm font-semibold leading-6 text-white flex items-center gap-x-1 hover:text-theme-gold transition-all duration-300 ease-in-out group">
                   ...
                   <div className="relative w-full h-16 sm:h-24">
                     <svg className="absolute block w-full h-16 sm:h-24 lg:bottom-2 bottom-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                       <path
                         ...
                         className="fill-theme-teal-light" // Changed Wave Color 1
                       ></path>
                     </svg>
                     <svg className="absolute block w-full h-16 sm:h-24 lg:left-20 left-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                        <path
                         d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z"
                         className="fill-theme-navy/80" // Changed Wave Color 2 (Subtler contrast)
                       ></path>
                     </svg>
                     <svg className="absolute block w-full h-16 sm:h-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                        <path
                         d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z"
                         className="fill-white" // Bottom wave connects to white Features section
                       ></path>
                     </svg>
                   </div>
                 </div>
            ...
            {/* Feature section (Kept white for clean contrast) */}
            <div className="bg-white py-16 sm:py-24" data-aos="fade-up">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                   {/* ... Feature content ... */}
                   <div className="mx-auto max-w-2xl lg:text-center" data-aos="fade-up">
                     <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-theme-teal/10 text-theme-teal mb-2" data-aos="fade-down" data-aos-delay="100">
                       Find Your Path
                     </span>
                     <p className="mt-2 text-3xl font-bold tracking-tight text-theme-navy sm:text-4xl" data-aos="fade-up" data-aos-delay="200">
                       Everything you need to grow and succeed
                     </p>
                     <p className="mt-6 text-lg leading-8 text-theme-slate" data-aos="fade-up" data-aos-delay="300">
                   ...
                   <div className="w-screen relative sm:left-[49%] sm:right-[51%] left-[49%] right-[49%] -ml-[50vw] -mr-[50vw] mt-16 py-12 px-6 overflow-hidden" data-aos="fade-up" data-aos-delay="400">
            ...
            {/* Stats section (Kept dark for impact) */}
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 relative">
                       ...
                       <div className="lg:col-span-1 relative lg:sticky top-0 self-start">
                         <div className="text-left space-y-4">
                           <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-theme-teal/20 text-theme-teal mb-2">
                             Platform Impact
                           </span>
                       ...
                       <div className="lg:col-span-1">
                         <div className="space-y-6">
                           <div className="grid grid-cols-1 gap-6">
                             {/* Active Users Stat */}
                             <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-white/20 transition-all duration-300" data-aos="fade-left" data-aos-delay="100">
                             ...
                             {/* Organizations Stat */}
                             <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-white/20 transition-all duration-300" data-aos="fade-left" data-aos-delay="200">
                               <div className="flex items-center justify-between">
                                 <div className="text-left">
                             ...
                             {/* Opportunities Stat */}
                             <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-white/20 transition-all duration-300" data-aos="fade-left" data-aos-delay="300">
                               <div className="flex items-center justify-between">
                                 <div className="text-left">
                     ...
                     >
                       <g clipPath="url(#clip0_11004_227)">
                         <path
                           ...
                           fill="white" // Lower wave transitions towards WhyWeExist's lighter bg
                         />
                         <path
                           opacity="0.6"
                           fillRule="evenodd"
                           ...
                           fill="url(#stats-wave-gradient)" // Use gradient defined below
                           />
                         <path
                           fillRule="evenodd"
                           clipRule="evenodd"
                           ...
                           // Matches the WhyWeExist top color for smooth transition
                           fill="url(#stats-top-wave-gradient)"
                         />
                       </g>
                       <defs>
                          {/* Gradient matching WhyWeExist bg */}
                          <linearGradient id="stats-top-wave-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                           <stop offset="0%" stopColor="var(--color-theme-cream-light)" />
                           <stop offset="100%" stopColor="var(--color-white)" />
                         </linearGradient>
                         {/* Subtle intermediate gradient */}
                         <linearGradient id="stats-wave-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                           <stop offset="0%" stopColor="var(--color-theme-cream)" stopOpacity="0.6"/>
                           <stop offset="100%" stopColor="var(--color-theme-cream-light)" stopOpacity="0.8" />
                         </linearGradient>
                         ...
                         <style>{`
                           :root {
                             --color-white: #ffffff;
                             --color-theme-cream-light: ${require('tailwindcss/colors').white}; /* Fallback */
                             --color-theme-cream: ${require('tailwindcss/colors').white}; /* Fallback */
                           }
                         `}</style>
                          {/* Inject actual theme colors via JS if needed, or ensure they resolve correctly */}
                         <script dangerouslySetInnerHTML={{ __html: `
                           document.documentElement.style.setProperty('--color-white', '#ffffff');
                           document.documentElement.style.setProperty('--color-theme-cream-light', '#fefcf7'); // Example: replace with actual theme color
                           document.documentElement.style.setProperty('--color-theme-cream', '#faf5eb'); // Example: replace with actual theme color
                         `}} />
                       </defs>
                     </svg>
                   </div>
            ...
            {/* Background is defined INSIDE the WhyWeExist component now */}
            {/* Keep the AOS wrapper */}
            <div data-aos="fade-up">
                <WhyWeExist />
            </div>


            {/* --- How CamboConnect Works Section --- */}
            {/* Use a subtle gradient leading from WhyWeExist's cream/white */}
            <section
                className="py-20 sm:py-28 bg-gradient-to-b from-white to-theme-cream-light/80" // Changed background
                data-aos="fade-up"
            >
                <div className="max-w-6xl mx-auto px-6 lg:px-8">
                    {/* ... How it works title ... */}
                     <motion.div
                       ...
                       data-aos="fade-up"
                     >
                       <span className="inline-block px-4 py-1 rounded-full text-sm font-medium bg-theme-teal/10 text-theme-teal mb-3" data-aos="fade-down" data-aos-delay="100">
                         Get Started Easily
                       </span>
                       <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-theme-navy mb-4" data-aos="fade-up" data-aos-delay="200">
                         How CamboConnect Works
                       </h2>
                       <p className="text-lg md:text-xl max-w-3xl mx-auto text-theme-slate" data-aos="fade-up" data-aos-delay="300">
            ...
            {/* Use the light sand color for warmth and separation */}
            <section
                className="py-20 sm:py-28 bg-theme-sand-light" // Changed background
                data-aos="fade-up"
            >
                <div className="max-w-6xl mx-auto px-6 lg:px-8">
                    {/* ... Testimonials title ... */}
                    <motion.div
                       ...
                       data-aos="fade-up"
                     >
                       <span className="inline-block px-4 py-1 rounded-full text-sm font-medium bg-theme-gold/10 text-theme-gold mb-3" data-aos="fade-down" data-aos-delay="100">
                         Community Voices
                       </span>
                       <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-theme-navy mb-4" data-aos="fade-up" data-aos-delay="200">
                         Success Stories
            ...
            {/* --- About Us Section --- */}
            {/* Keep white background for clean contrast before footer and to make inner card pop */}
            <section
                className="py-20 sm:py-28 bg-white" // Changed background
                data-aos="fade-up"
            >
                <div className="max-w-6xl mx-auto px-6 lg:px-8">
                   {/* ... About Us title ... */}
                   <motion.div
                     ...
                     data-aos="fade-up"
                   >
                     <span className="inline-block px-4 py-1 rounded-full text-sm font-medium bg-theme-navy/10 text-theme-navy mb-3" data-aos="fade-down" data-aos-delay="100">
                       Our Story
                     </span>
                     <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-theme-navy mb-4" data-aos="fade-up" data-aos-delay="200">
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                       ...
                       >
                         <img
                           ...
                           className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                           // Consider adding unoptimized prop if not using Next.js Image optimization for this external URL
                           // unoptimized
                         />
