  ...
  return (
    <MainLayout>
      <div className="font-body text-theme-slate">
        {/* Header Section */}
        <section className="bg-gradient-to-b from-theme-navy to-theme-navy/90 text-white py-16">
        ...
        <section className="py-12 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <motion.div
              className="bg-theme-cream rounded-xl p-6 md:p-10 shadow-sm"
              initial="hidden"
              whileInView="visible"
                  ...
                  <div className="md:w-1/2">
                    ...
                    <ul className="space-y-3 mb-6">
                      {step.steps.map((substep, i) => (
                        <li key={i} className="flex items-start bg-white p-3 rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              {advancedTips.map((tip, index) => (
                <motion.div
                  key={index}
                  className="bg-theme-cream rounded-xl p-6 flex shadow-sm border border-gray-100"
                  variants={fadeIn}
                  whileHover={{ y: -5 }}
                >
                  <div className="bg-white p-3 rounded-full mr-4 flex-shrink-0 shadow-sm text-theme-teal">
                    {tip.icon}
                  </div>
                  <div>
                    <h3 className="font-semibold text-xl text-theme-navy mb-2">{tip.title}</h3>
                    <p className="text-theme-slate">{tip.description}</p>
                  </div>
                </motion.div>
              ))}
            </motion.div>
              ...
              {[
                ...
                >
                  <details className="group">
                    ...
                    <div className="px-6 pb-6 pt-0 text-theme-slate">
                      <p>{faq.answer}</p>
                    </div>
                  </details>
                </motion.div>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              {[
                ...
                <motion.div
                  key={index}
                  className="bg-theme-cream rounded-xl overflow-hidden shadow-md border border-gray-100"
                  variants={fadeIn}
                >
                  <div className="aspect-video bg-gray-100 relative flex items-center justify-center">
                    <span className="absolute inset-0 flex items-center justify-center">
                      <span className="bg-theme-teal bg-opacity-90 rounded-full p-4 cursor-pointer shadow-md hover:bg-opacity-100 transition-all duration-300">
            ...
            <motion.div
              ...
              variants={fadeIn}
            >
              <a href="#" className="inline-flex items-center text-theme-teal hover:text-theme-teal/90 font-semibold transition-colors">
                View all tutorials
        ...
        <section className="py-12 bg-theme-navy text-white">
          <div className="max-w-6xl mx-auto px-4">
            <motion.div
              className="bg-gradient-to-r from-theme-teal to-theme-navy/90 border border-theme-teal/30 rounded-xl p-8 text-center shadow-lg"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-100px" }}
              variants={fadeIn}
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.button
                  className="bg-white text-theme-navy hover:bg-gray-100 px-8 py-3 rounded-lg font-semibold text-lg flex items-center justify-center transition-colors"
                ...
                <motion.button
                  className="border-2 border-white text-white hover:bg-white hover:text-theme-navy px-8 py-3 rounded-lg font-semibold text-lg flex items-center justify-center transition-colors"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Visit FAQ
