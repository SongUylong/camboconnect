...
export enum FilterType {
  ...
  CATEGORY = "Category",  // Add CATEGORY enum value
}
...
const FilterIcon = ({
  ...
  switch (type) {
    ...
    case FilterType.CATEGORY:
      return <Tag className="size-3.5" />;  // Using Tag icon for categories
...
export const filterViewToFilterOptions: Record<FilterType, FilterOption[]> = {
  ...
  [FilterType.CATEGORY]: [], // Add empty array for CATEGORY to be populated dynamically
};
